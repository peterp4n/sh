...
BACKDIR=backup
FULLBACKUPCYCLE=518400  # 604800 # Create a new full backup every X seconds
KEEP=4 # Number of additional backups cycles a backup should kept for.
